from managers import stat_manager, rule_manager, alert_manager, context_manager
from modules import modules
import utils.context as context

class FrameProcessor:
    def __init__(self):
        self.sm = stat_manager.get()
    ...
    def process(self, frame, source=None, frame_number=None):
        ...
        #         alerts = module.on_frame(frame, self.sm, {"source": source, "frame_number": frame_number, "channel": context.get_channel(frame)})
